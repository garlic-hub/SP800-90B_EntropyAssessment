...
double most_common(const uint8_t* data, const long len, const int alph_size, const int verbose, const char *label, TestCaseBase &tc){
...
double most_common(const uint8_t* data, const long len, const int alph_size, const int verbose, const char *label){
